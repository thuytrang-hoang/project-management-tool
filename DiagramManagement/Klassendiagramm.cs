...
{
    // Form for creating and managing "Klassendiagramm"
    public partial class Klassendiagramm : Form
    {
        ...
        private void aggregationImage_Click(object sender, EventArgs e)
        {
            string imagePath = @"Images\AggregationImage.png";
            CreateAndAddImage(imagePath, new Size(120, 120), new Point(150, 150));
        }
        private void kompositionImage_Click(object sender, EventArgs e)
        {
            string imagePath = @"Images\CompositionImage.png";
            CreateAndAddImage(imagePath, new Size(120, 120), new Point(150, 150));
        }
